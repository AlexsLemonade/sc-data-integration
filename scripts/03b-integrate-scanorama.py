...
parser.add_argument('--use_hvg',
                    ...
                    'If --use_hvg is used, integration will only consider highly variable genes, and similarly the returned integrated object will only contain the highly variable genes.')
