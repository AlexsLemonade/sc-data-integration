...
if (celltypes_present) {
  # Not separated
  asw_results <- run_asw(sce_list, params$celltype_column, params$seed, by_group = FALSE)
  print(asw_results$asw_plot)
  
  # Separated
  asw_results <- run_asw(sce_list, params$celltype_column, params$seed, by_group = TRUE, group_label = "Cell type")
  print(asw_results$asw_plot)
} else {
