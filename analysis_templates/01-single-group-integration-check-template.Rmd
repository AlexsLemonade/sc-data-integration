...
Here we calculate the what we will refer to as the within bath ARI. 
The goal of this metric is to measure how well a given integration method preserves biological heterogeneity by comparing clustering assignments from pre integration to post integration for each library. 
...
```{r}
# purrr across the list of integrated sce objects to compare against the individual objects 
