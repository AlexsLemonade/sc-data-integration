...
The batch silhouette width, averaged across analysis replicates, therefore measures to what extent a given data point adheres to its batch group, which is not desired after integration.
