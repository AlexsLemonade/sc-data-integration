...
Read in integrated SCE objects.
...
Read in pre-integrated SCE objects.
...
ggplot(within_batch_ari, aes(x = integration_method_factor , y = ari)) +
  geom_point() +
  ggforce::geom_sina() +
