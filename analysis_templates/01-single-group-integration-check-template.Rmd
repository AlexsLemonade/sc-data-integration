...
As this measure may be become increasingly difficult to interpret as data dimensionality increases, the additional measure scaled PC regression is the "sum of explained variance of all PCs" that are significantly correlated to batches, and it represents a more robust "proxy for the batch effect."
