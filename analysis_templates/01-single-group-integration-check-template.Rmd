...
```{r}
# separate out merged sce for calculation of metrics and 
#  convenient calculation of celltype information
...
if(params$celltype_column %in% coldata_names){
  ...
  celltypes <- colData(merged_sce)[[params$celltype_column]]
...
Cells without annotations are not considered in calculations or visualizations that assess cell type mixing.
  ...
  glue::glue(
      "No celltype information found for this dataset. Cannot make UMAPs annotated with celltype or evaluate celltype mixing."
  )
}
